                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img style="width:400px; height: auto;" src="{{ asset('public/app-assets/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <hr>
                                                    <br><br>
                                                    <a href="{{ URL::to('/sign-up') }}" class="btn btn-outline-primary float-left btn-inline">Register</a>
